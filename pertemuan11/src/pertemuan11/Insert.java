...
public class Insert extends javax.swing.JDialog {
    ...
    private void btnsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsaveActionPerformed
        ...
        if (txtplat.getText().equals("")) {
            ...
            String platnomor, merk, warna, tanggalproduksi;
            platnomor = txtplat.getText();
            merk = txtmerk.getText();
            warna = cbwarna.getSelectedItem().toString();
            tanggalproduksi = txtplat.getSelectedText();

            EntityManager em = emf.createEntityManager();
            em.getTransaction().begin();

            Kendaraan dk = new Kendaraan();
            dk.setPlatnomor(platnomor);
            dk.setMerk(merk);
            dk.setWarna(warna);
            dk.setTanggalproduksi(tanggalproduksi);
