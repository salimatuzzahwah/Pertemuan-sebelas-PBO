...
public class DataKendaraan extends javax.swing.JFrame {
    ...
    private void btnclose1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnclose1ActionPerformed
        try {
            ...
            Connection conn = DriverManager.getConnection("jdbc:postgresql://localhost:5432/PBO", "postgres", "elma123");
            ...
            try (BufferedReader br = new BufferedReader(new FileReader(filePilihan))) {
                ...
                while ((baris = br.readLine()) != null) {
                    ...
                    if (data.length == 4) {
                        ...
                        dk.setPlatnomor(data[0].trim());
                        dk.setMerk(data[1].trim());
                        dk.setWarna(data[2].trim());
                        dk.setTanggalproduksi(data[3].trim());
